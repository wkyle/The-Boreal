...
function initMapBoxMap(mapdata) {
    ...
    var corner1 = L.latLng(mapdata["bbox"][1]-1, mapdata["bbox"][0]-1);
    var corner2 = L.latLng(mapdata["bbox"][3]+1, mapdata["bbox"][2]+1);
    var mapbounds = L.latLngBounds(corner1, corner2)
    var mymap = L.map('mapboxmap', {attributionControl: false, maxBounds: mapbounds}).setView([61, -95], 3);
